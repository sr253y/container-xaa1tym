...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-xaa1tym.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-xaa1tym.containers.anotherwebservice.com/
...
```
git clone git@github.com:sr253y/container-xaa1tym.git
cd container-xaa1tym
```
...
```
docker attach container-xaa1tym
```
